         ...
         <div className="m-6 md:m-12 pb-20">
            ...
            <p className="text-center">Effective: October 1, 2024</p>
             <div className="mt-6">
                ...
                <p>High Low Media takes privacy seriously, but High Low Media uses a technology stack with dependencies, ultimately even including the means by which you the user accesses our Services, that High Low Media cannot answer fully for with respect to data collection practices or impractices, as the case may be.</p>
                ...
                <ul>
                    ...
                    <li>Affiliates: We may disclose Personal Information to our affiliates, meaning an entity that controls, is controlled by, or is under common control with High Low Media. Our affiliates may use the Personal Information we share in a manner consistent with this Privacy Policy.</li>
                    <li>Other Users and Third Parties You Share Information With: Certain features allow you to display or share information with other users or third parties.</li>
                </ul>
            </div>
        </div>
